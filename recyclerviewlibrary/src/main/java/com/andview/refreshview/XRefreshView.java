...
public class XRefreshView extends LinearLayout {
    ...
    private MyRoundCanvas myRoundCanvas;
     ...
     * 被刷新的view
     */
    public XRefreshContentView mContentView;
     ...
     */
    private boolean enableRecyclerViewPullUp = false;
    /**
    ...
    private void initWithContext(Context context, AttributeSet attrs) {
        ...
        myRoundCanvas=(MyRoundCanvas)mHeaderView.findViewById(R.id.roundProgressBar2);
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if ((mPullLoading || mPullRefreshing) && mIsPinnedContentWhenRefreshing) {
                    ...
                    if(mContentView.isTop()){
                        if(pullDownY>0){
                            myRoundCanvas.setProgress((int) pullDownY);
                        }else{
                            pullDownY=0;
                        }
...
//                LogUtilss.i("isTop=" + mContentView.isTop() + ";isBottom=" + mContentView.isBottom());
     ...
     * @param hideFooter hide footerview if true
     */
    public void stopLoadMore(final boolean hideFooter,final boolean contentView) {
        if (needAddFooterView()) {
            if (mPullLoading == true) {
                mStopingRefresh = true;
                mState = XRefreshViewState.STATE_COMPLETE;
        ...
        mContentView.stopLoading(contentView);
    }
...
//        mFooterCallBack.onStateRefreshing();
    ...
    public void loadFalseNow(){
        mContentView.loadFalse();
    }
    /**
